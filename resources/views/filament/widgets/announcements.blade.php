<x-filament-widgets::widget>
    <x-filament::section>
        <div style="display:flex;align-items:center;gap:8px;">
            ...
            <h3 style="margin:0;font-size:15px;font-weight:800;color:#2f43b8;">Berita & Pengumuman</h3>
        </div>
            ...
            @forelse ($this->getAnnouncements() as $a)
                <div style="border:1px solid #e5e7eb;border-radius:12px;padding:16px;">
                    <div style="display:flex;align-items:center;gap:6px;">
                        <span style="font-size:10px;font-weight:700;text-transform:uppercase;letter-spacing:.04em;padding:1px 7px;border-radius:9999px;
                                     {{ $a->jenis === \App\Enums\AnnouncementType::Berita ? 'background:#dbeafe;color:#1d4ed8;' : 'background:#e5e7eb;color:#374151;' }}">
                            {{ $a->jenis->label() }}
                        </span>
                        <div style="display:flex;align-items:center;gap:4px;font-size:11px;font-weight:700;text-transform:uppercase;letter-spacing:.04em;color:#3b5bd9;">
                            @if ($a->disematkan)
